...
namespace FilmesAPI.Migrations
{
    ...
    [Migration("20231016164015_Mudando deleção de um objeto Endereco de Cascade para Restrict")]
    partial class MudandodeleçãodeumobjetoEnderecodeCascadeparaRestrict
    {
        /// <inheritdoc />
